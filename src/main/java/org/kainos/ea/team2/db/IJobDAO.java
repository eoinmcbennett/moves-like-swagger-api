...
public interface IJobDAO {
    ...
    /**
     * Interface of job dao class, returns job spec, sharepoint link and responsibilities from db.
     * @param id job id of returned job spec, sharepoint link and responsibilities
